...
public class Task2 {
	...
	public static void main(String[] args) {
		...
		while(attempt<maxAttempts)
		{
			...
			{
				System.out.println("The Number should be greated than "+a+" Your Attempts left are : "+(maxAttempts-attempt));
			}
		
			else
			{
				System.out.println("The Number should be lesser than "+a+" Your Attempts left are : "+(maxAttempts-attempt));
			}
